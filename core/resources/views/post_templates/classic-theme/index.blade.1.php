                    ...
                    <div class="single-page-header-inner">
                        <div class="left-side">
                            ...
                            <div class="header-details ">
                                ...
                                @if (isset($getUserBusinessTable) && $getUserBusinessTable->table_id)
...
@endif
                        ...
                        <div class="user-lang-wrapper d-flex">
                            ...
                            @if(@$postOptions->allow_call_waiter && $hasqr_id)
    ...
    <!-- Order Form -->
    <div id="order-form" class="zoom-anim-dialog mfp-hide dialog-with-tabs popup-dialog">
        <div class="sign-in-form">
            <ul class="popup-tabs-nav">
                <li><a class="menu_title">{{ ___('Order Form') }}</a></li>
            </ul>
            <div class="popup-tabs-container">
                <div class="popup-tab-content">
                    <div class="menu_detail">
            ...
            <div class="popup-tabs-container">
                <div class="popup-tab-content">
                    ...
                    <form type="post" action="{{ route('restaurant.callTheWaiter', $post->id) }}" id="call-waiter-form">
                            @csrf
                            <input id="table-number-field tw-disabled" type="number" class="with-border" name="table"
                                   placeholder="{{ ___('Table Number') }}" value="{{$getUserBusinessTable->table_id}}" readonly>
                                   <input type="hidden" data-table="{{$getUserBusinessTable->table_id}}">
...
<div id="feedback-form-dialog" class="zoom-anim-dialog mfp-hide dialog-with-tabs">
        ...
        <div class="sign-in-form">
            ...
            <select id="rating" name="rating" class="form-control tw-w-full tw-mt-1 tw-p-2 tw-border tw-rounded">
        ...
        <div class="form-group tw-mb-4">
            ...
            <textarea id="comment" name="comment" class="form-control tw-w-full tw-mt-1 tw-p-2 tw-border tw-rounded" rows="4" placeholder="Yorumunuzu buraya yazın..."></textarea>
        </div>
                        <!-- Button -->
        ...
        <div class="footer-bottom-section">
            <div class="container">
                <div class="footer-rows-left">
                    <div class="footer-row padding-top-0 tw-center">
