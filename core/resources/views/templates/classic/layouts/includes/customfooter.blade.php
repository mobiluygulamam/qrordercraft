        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="tw-grid tw-grid-cols-5 tw-gap-y-8 tw-w-full">
                         <a href="{{route('aboutUs')}}" target="_blank" rel="nofollow">{{___('about_us')}}</a>
                         <a href="{{route('privacyPolicy')}}" target="_blank" rel="nofollow">{{___('privacy_policy')}}</a>
                         <a href="{{route('termsandconditions')}}" target="_blank" rel="nofollow">{{___('terms_and_conditions')}}</a>
                         <a href="{{route('contactInformation')}}" target="_blank" rel="nofollow">{{___('contact_information')}}</a>
                         <a href="https://www.shopier.com/craftorder" target="_blank" rel="nofollow">{{___('purchase_now')}}</a>
