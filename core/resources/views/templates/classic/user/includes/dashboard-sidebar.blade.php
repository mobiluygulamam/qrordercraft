                      ...
                      <div class="dashboard-nav-inner">
                          ...
                          <ul data-submenu-title="{{ ___('Organize and Manage') }}">
                              ...
                              <li class="{{ request()->route()->getName() == 'restaurants.index' || request()->route()->getName() == 'restaurants.qrbuilder' ? 'active' : '' }}"><a
                                      ...
                                      <li class="{{ request()->route()->getName() == 'integrations' ? 'active' : '' }}">
                                        <a href="{{ route('integrations') }}" class="relative flex items-center p-2 rounded hover:bg-gray-700">
                                            <i class="far fa-rocket"></i>
                                            <span class="ml-3">{{ ___('integrations') }}</span>
                                            <!-- Badge -->
                                            <span class="absolute top-0 right-0 -mt-1 -mr-1 tw-bg-red-400 tw-text-white tw-text-xs tw-font-bold tw-px-2 tw-rounded-full">
                                                Yakında
                                            </span>
                                        </a>
                                    </li>
                                      ...
                                      <li class="{{ request()->route()->getName() == 'feedbacks' ? 'active' : '' }}"><a
                                         href="{{ route('feedbacks') }}"><i
                                             class="far fa-thumbs-up"></i> {{ ___('feedbacks') }}</a>
