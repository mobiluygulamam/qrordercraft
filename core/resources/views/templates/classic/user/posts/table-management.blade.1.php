            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.error) {
                        ...
                        var details = `<div class="tw-h-10"></div>
                            <div class="tw-relative"> 
                            <div id="qr-cards" class="tw-place-content-center  tw-bg-white tw-shadow-md tw-rounded-lg tw-p-4 tw-max-w-40 tw-mb-4 tw-text-center">
                                <!-- İşletme logosu -->
                                <div class="tw-mb-4">
                            ...
                            <div class="tw-p-4">
                                <button id="download-button" type="button" class="tw-mt-4 tw-bg-blue-500 tw-text-white tw-px-4 tw-py-2 tw-rounded">QR Kartını İndir</button>
                            </div>
                            ...
                            <button id="update-table-status" class="btn btn-primary">Update</button>`;
