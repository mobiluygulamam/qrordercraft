    ...
    <div class="row">
        ...
        <div class="col-md-4 sticky-sidebar">
            <div class="dashboard-box">
                ...
                <div class="content with-padding">
                    @php 
                    $dataUrl="{{ route('publicView', $post->slug). '?qr-id=' . urlencode(coffecraft_xor_encrypt($post->slug, 'craftapp')) }}";
                   @endphp
                    <div id="qr-code-wrapper" class="margin-bottom-20" data-url="{{$dataUrl}}"></div>
