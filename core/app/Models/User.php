...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function device(){
     return $this->belongsTo(\AwaisMosh\LaravelDeviceTracking\Models\Device::class);
    ...
    public function plan()
    {
        if(is_numeric($this->group_id)){
            return Plan::find($this->group_id);
    ...
    public function businessTables()
    {
        return $this->hasMany(BusinessTables::class)->latest();
    }

    public function staffMembers()
    {
        return $this->hasMany(StaffMember::class)->latest();
    }
