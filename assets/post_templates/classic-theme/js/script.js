(function ($) {
    ...
    localStorage.setItem('CraftOrder_order', '[]');
    ...
    */
    $(document).on('click', ".add-extras", function (e) {
        ...
        /* Variant */
        $.each(js_variants, function (_key, item) {
            var variants_key = '';
        ...
        for (var i in variant_options) {
            if (variant_options.hasOwnProperty(i)) {
                ...
                $options_tpl.find('.radio input').on('click', function () {
                    ...
                    $('input[name^="variant-radio-"]').each(function (_key, item_option_element) {
                    ...
                    $('input[name^="variant-radio-"]:checked').each(function (_key, item) {
                    ...
                    $('input[name^="variant-radio-"]:checked').each(function (_key, element) {
        ...
        $('#menu-order-quantity-decrease').off().on('click', function (_e) {
        ...
        $('#menu-order-quantity-increase').off().on('click', function (_e) {
            $('#menu-order-quantity').val(Number($('#menu-order-quantity').val()) + 1);
            calculateOrderPrice();
        });

        $('#add-order-button').off().on('click', function (_e) {
            calculateOrderPrice();
            var price = $('#order-price').html();
            var order_data = JSON.parse(localStorage.getItem('CraftOrder_order'));
            ...
            localStorage.setItem('CraftOrder_order', JSON.stringify(order_data));
    ...
    * View Order
    */
    $('#view-order-button').on('click', function (_e) {
        var order_data = JSON.parse(localStorage.getItem('CraftOrder_order'));
    ...
    * Ordering type
    */
    $("#ordering-type").on("change", function (_e) {
