(function ($) {
    ...
    $('.edit-category').off('click').on('click', function (e) {
        e.stopPropagation();
        e.preventDefault();
    ...
    /* Sub Category */
    $('.add-sub-category').off('click').on('click', function (e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    $('.add-menu-item').off('click').on('click', function (e) {
        e.stopPropagation();
        e.preventDefault();
    ...
    $('.edit-image-menu-item').off('click').on('click', function (e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    $('.show-hide-submit-field').on('click', function () {
